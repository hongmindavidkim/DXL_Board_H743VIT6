...
XM430_bus dxl_bus_1(&huart1, RTS1_GPIO_Port, RTS1_Pin); // MCP, PIP
XM430_bus dxl_bus_2(&huart2, RTS2_GPIO_Port, RTS2_Pin); // DIP, MCR

uint8_t dxl_IDs[] = {1, 2, 3, 4};
uint8_t dxl_ID1[] =  {1, 2}; // MCP, PIP
uint8_t dxl_ID2[] = {3, 4};  // DIP, MCR`
uint8_t idLength1 = 2;
uint8_t idLength2 = 2;
